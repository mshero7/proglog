...
type ProduceRequest struct {
	...
	Record *Record `protobuf:"bytes,1,opt,name=record,proto3" json:"record,omitempty"` // record ID``
}
...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x65, 0x53, 0x74, 0x72, 0x65, 0x6d, 0x61, 0x12, 0x16, 0x2e, 0x6c, 0x6f, 0x67, 0x2e, 0x76, 0x31,
	...
	0x5a, 0x1d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x73, 0x68,
	0x65, 0x72, 0x6f, 0x37, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6c, 0x6f, 0x67, 0x5f, 0x76, 0x31, 0x62,
...
var file_api_v1_log_proto_depIdxs = []int32{
	...
	1, // 5: log.v1.Log.ProduceStrema:input_type -> log.v1.ProduceRequest
	...
	2, // 9: log.v1.Log.ProduceStrema:output_type -> log.v1.ProduceResponse
